...
export class PresenceClient {
	...
	/** Herdr app v0.9.1 (protocol 22) renders fixed display fields, a summary-derived title, and the complete V2 token patch; v9 names the managed integration asset. */
	async metadata(
