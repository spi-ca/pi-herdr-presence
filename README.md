...
Presentation is always fixed: title and display agent are `Pi`. No cwd, prompt, session name/path, task or subagent argument, output, or raw error is read or projected.
