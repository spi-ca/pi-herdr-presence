...
- Herdr reporting now documents the fixed ten-token V2 projection, summary-derived standalone title, fixed display fields, standalone versus companion envelopes and cleanup, managed authority fail-closed behavior, and privacy boundaries.
